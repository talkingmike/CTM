...
S = {-4, -2, 1, 2, 5, 0}
# Replace [ ... ] with a one-line list comprehension in which S appears
exclude_zero_list = [(x,y,z) for x in S for y in S for z in S if (x+y+z == 0) and ((x != 0) or (y != 0))]
...
first_of_tuples_list = [(x,y,z) for x in S for y in S for z in S if (x+y+z == 0) and ((x != 0) or (y != 0))][0]
